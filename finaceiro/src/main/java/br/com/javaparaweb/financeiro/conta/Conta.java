...
public class Conta implements Serializable {
	...
	//Ao Criar esta classe não esqueça de registrar o mapping no hibernate.cfg.xml
	...
	@ManyToOne
	@OnDelete(action = OnDeleteAction.CASCADE) //se um registro de usuario for excluido tenham automaticamente suas contas excluidas.
