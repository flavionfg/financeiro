...
public class Usuario implements Serializable {
	...
	/* @ElementCollection - declara qual o tipo da classe que será carregada no conjunto(Set) de valores,aqui é string : ROLE_ADMINISTRADOR E ROLE_USUARIO.
	 * @JoinTable configuração name : descreve o nome da tabela no lado "muitos" dessa relacionamento, se nao colocar o Hibernate cria sozinha baseado na tabela pai e filho,sendo usuario pai e permissoes filho.
	 * @JoinTable configuração uniqueConstraints : criará um indice único na tabela usuario_permissao entre os campos usuario e permissao,pois o usuario não pode ter permissoes repetidas.
