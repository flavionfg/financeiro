...
/* 1 - A classe MensagemUtil centraliza a recuperação de mensagens intercionalizadas do sistema, a mensagem é contida na chave
 * cheque_erro_sequencia
 * 
 * 2 - Estamos criando uma nova mensagem via FacesMessage, que será mostrada para o usuario, no presente caso,para alertar que 
 * não foi informada uma sequência de cheques para cadastro.
 * 
 */ 
