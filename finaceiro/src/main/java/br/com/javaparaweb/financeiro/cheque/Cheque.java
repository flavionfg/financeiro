...
/* Não é necessario criar métodos get and set para SITUACAO_CHEQUE_BAIXADO,SITUACAO_CHEQUE_NAO_EMITIDO,SITUACAO_CHEQUE_CANCELADO.
 * 
 * 1 - Usamos a Tag @Embedded,para mapear uma chave primaria composta,Encapsulamos as propriedades que idendificam a chave em uma 
 * classe à parte e inserimos essa classe como uma propriedade da classe principal Cheque.
 * 
 * 2 - Mapeamento um-para-um, aqui não há dependência de valor gerado, por uma chave, e sim uma relação indicando que um 
 * lançamento poderá ter um unico cheque vinculado, e cheque também está vinculado, isso é uma regra de negocio.
 * 
 */
